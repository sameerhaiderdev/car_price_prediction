...
st.header("Car Price Predictions ML Model")
...
year=st.slider("Car Manufatured year",1994,2024)
km_driven=st.slider("no. of km driven",11,200000)
fuel=st.selectbox("fuel type",cars_data["fuel"].unique())
seller_type=st.selectbox("Seller Type",cars_data["seller_type"].unique())
transmission=st.selectbox("Tansmission Type",cars_data["transmission"].unique())
owner=st.selectbox("Owner Type",cars_data["owner"].unique())   # ✅ FIXED here
